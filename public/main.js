...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 5280944,
    DYNAMIC_BASE = 5280944,
    DYNAMICTOP_PTR = 38032;
...
var _decodeOggPage = Module["_decodeOggPage"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_decodeOggPage"].apply(null, arguments)
};
...
var _lengthOfOutput = Module["_lengthOfOutput"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_lengthOfOutput"].apply(null, arguments)
};
